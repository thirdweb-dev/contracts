...
export interface ERC721AQueryableUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface ERC721AQueryableUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721AQueryableUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: ERC721AQueryableUpgradeableInterface;
