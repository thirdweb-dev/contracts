...
export interface TWRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "OPERATOR_ROLE"
...
export namespace AddedEvent {
  export type InputTuple = [deployer: AddressLike, deployment: AddressLike];
  export type OutputTuple = [deployer: string, deployment: string];
...
export interface TWRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): TWRegistry;
  ...
  add: TypedContractMethod<
    [_deployer: AddressLike, _deployment: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getAll: TypedContractMethod<[_deployer: AddressLike], [string[]], "view">;
  ...
  ): TypedContractMethod<[_deployer: AddressLike], [string[]], "view">;
  getFunction(
  ...
  filters: {
    "Added(address,address)": TypedContractEvent<
      AddedEvent.InputTuple,
      AddedEvent.OutputTuple,
      AddedEvent.OutputObject
    >;
    ...
    "Deleted(address,address)": TypedContractEvent<
      DeletedEvent.InputTuple,
      DeletedEvent.OutputTuple,
      DeletedEvent.OutputObject
    >;
