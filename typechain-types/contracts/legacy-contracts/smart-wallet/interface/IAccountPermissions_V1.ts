...
export interface IAccountPermissions_V1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "getAllActiveSigners"
      | "getAllAdmins"
...
export namespace SignerPermissionsUpdatedEvent {
  export type InputTuple = [
    ...
    permissions: IAccountPermissions_V1.SignerPermissionRequestStruct
  ];
...
export interface IAccountPermissions_V1 extends BaseContract {
  connect(runner?: ContractRunner | null): IAccountPermissions_V1;
  ...
  setAdmin: TypedContractMethod<
    [account: AddressLike, isAdmin: boolean],
    [void],
    "nonpayable"
  >;
