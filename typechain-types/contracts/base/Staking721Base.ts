...
export interface Staking721BaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "claimRewards"
      | "contractURI"
...
export interface Staking721Base extends BaseContract {
  connect(runner?: ContractRunner | null): Staking721Base;
  ...
  nativeTokenWrapper: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "nativeTokenWrapper"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
