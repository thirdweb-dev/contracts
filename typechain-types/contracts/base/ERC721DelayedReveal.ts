...
export interface ERC721DelayedRevealInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface ERC721DelayedReveal extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721DelayedReveal;
  ...
  claim: TypedContractMethod<
    [_receiver: AddressLike, _quantity: BigNumberish],
    [void],
    "payable"
  >;
  ...
  verifyClaim: TypedContractMethod<
    [_claimer: AddressLike, _quantity: BigNumberish],
    [void],
    "view"
  >;
