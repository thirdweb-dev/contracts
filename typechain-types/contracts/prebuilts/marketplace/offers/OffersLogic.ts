...
export interface OffersLogicInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_msgData"
      | "_msgSender"
...
export interface OffersLogic extends BaseContract {
  connect(runner?: ContractRunner | null): OffersLogic;
  ...
  totalOffers: TypedContractMethod<[], [bigint], "view">;
