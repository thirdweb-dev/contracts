...
export interface IAirdropERC20ClaimableInterface extends Interface {
...
export interface IAirdropERC20Claimable extends BaseContract {
  connect(runner?: ContractRunner | null): IAirdropERC20Claimable;
  waitForDeployment(): Promise<this>;

  interface: IAirdropERC20ClaimableInterface;
