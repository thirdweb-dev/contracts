...
export declare namespace IDropERC1155 {
...
export interface IDropERC1155Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
  ...
  encodeFunctionData(
    ...
    values: [
      ...
      AddressLike,
      BigNumberish,
      IDropERC1155.AllowlistProofStruct,
      BytesLike
    ]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, IDropClaimCondition.ClaimConditionStruct[], boolean]
  ): string;
  encodeFunctionData(
...
export interface IDropERC1155 extends BaseContract {
  connect(runner?: ContractRunner | null): IDropERC1155;
  ...
  claim: TypedContractMethod<
    [
      ...
      currency: AddressLike,
      pricePerToken: BigNumberish,
      allowlistProof: IDropERC1155.AllowlistProofStruct,
      data: BytesLike
    ],
    [void],
    "payable"
