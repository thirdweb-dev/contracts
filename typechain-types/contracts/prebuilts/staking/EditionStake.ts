...
export interface EditionStakeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "claimRewards"
...
export interface EditionStake extends BaseContract {
  connect(runner?: ContractRunner | null): EditionStake;
  waitForDeployment(): Promise<this>;

  interface: EditionStakeInterface;
