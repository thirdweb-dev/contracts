...
export interface AirdropERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "airdropERC721"
...
export interface AirdropERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): AirdropERC721;
  ...
  airdropERC721: TypedContractMethod<
    [
      ...
      _contents: IAirdropERC721.AirdropContentStruct[]
    ],
    [void],
    "nonpayable"
  >;
