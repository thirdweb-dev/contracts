...
export interface AirdropERC721ClaimableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "airdropTokenAddress"
      | "availableAmount"
...
export interface AirdropERC721Claimable extends BaseContract {
  connect(runner?: ContractRunner | null): AirdropERC721Claimable;
  waitForDeployment(): Promise<this>;

  interface: AirdropERC721ClaimableInterface;
