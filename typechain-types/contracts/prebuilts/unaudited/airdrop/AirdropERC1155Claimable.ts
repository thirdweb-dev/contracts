...
export interface AirdropERC1155ClaimableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "airdropTokenAddress"
      | "availableAmount"
...
export interface AirdropERC1155Claimable extends BaseContract {
  connect(runner?: ContractRunner | null): AirdropERC1155Claimable;
  ...
  availableAmount: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  merkleRoot: TypedContractMethod<[arg0: BigNumberish], [string], "view">;

  multicall: TypedContractMethod<[data: BytesLike[]], [string[]], "nonpayable">;

  openClaimLimitPerWallet: TypedContractMethod<
    [arg0: BigNumberish],
    [bigint],
    "view"
  >;
