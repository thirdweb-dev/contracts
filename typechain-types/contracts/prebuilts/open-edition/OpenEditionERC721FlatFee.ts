...
export interface OpenEditionERC721FlatFeeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "approve"
...
export interface OpenEditionERC721FlatFee extends BaseContract {
  connect(runner?: ContractRunner | null): OpenEditionERC721FlatFee;
  ...
  startTokenId: TypedContractMethod<[], [bigint], "view">;
