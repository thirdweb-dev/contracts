...
export interface PackVRFDirectInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "sendRewardsIndirect",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface PackVRFDirect extends BaseContract {
  connect(runner?: ContractRunner | null): PackVRFDirect;
  ...
  sendRewardsIndirect: TypedContractMethod<
    [_opener: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "sendRewardsIndirect"
  ): TypedContractMethod<[_opener: AddressLike], [void], "nonpayable">;
  getFunction(
