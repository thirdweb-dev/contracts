...
export interface SignatureMintERC721UpgradeableInterface extends Interface {
  getFunction(
...
export interface SignatureMintERC721Upgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): SignatureMintERC721Upgradeable;
  waitForDeployment(): Promise<this>;

  interface: SignatureMintERC721UpgradeableInterface;
