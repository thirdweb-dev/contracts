...
export interface Staking1155UpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "claimRewards"
...
export interface Staking1155Upgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): Staking1155Upgradeable;
  waitForDeployment(): Promise<this>;

  interface: Staking1155UpgradeableInterface;
