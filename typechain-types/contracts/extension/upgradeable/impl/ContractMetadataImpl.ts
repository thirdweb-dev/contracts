...
export interface ContractMetadataImplInterface extends Interface {
  getFunction(
...
export interface ContractMetadataImpl extends BaseContract {
  connect(runner?: ContractRunner | null): ContractMetadataImpl;
  waitForDeployment(): Promise<this>;

  interface: ContractMetadataImplInterface;
