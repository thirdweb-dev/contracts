...
export interface RulesEngineInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface RulesEngine extends BaseContract {
  connect(runner?: ContractRunner | null): RulesEngine;
  ...
  deleteRule: TypedContractMethod<[_ruleId: BytesLike], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[_ruleId: BytesLike], [void], "nonpayable">;
  getFunction(
