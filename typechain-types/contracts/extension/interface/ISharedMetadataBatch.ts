...
export interface ISharedMetadataBatchInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ISharedMetadataBatch extends BaseContract {
  connect(runner?: ContractRunner | null): ISharedMetadataBatch;
  ...
  setSharedMetadata: TypedContractMethod<
    [metadata: ISharedMetadataBatch.SharedMetadataInfoStruct, id: BytesLike],
    [void],
    "nonpayable"
  >;
