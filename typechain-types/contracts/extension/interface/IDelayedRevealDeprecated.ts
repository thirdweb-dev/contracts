...
export interface IDelayedRevealDeprecatedInterface extends Interface {
  getFunction(
    nameOrSignature: "encryptDecrypt" | "encryptedBaseURI" | "reveal"
  ): FunctionFragment;
...
export interface IDelayedRevealDeprecated extends BaseContract {
  connect(runner?: ContractRunner | null): IDelayedRevealDeprecated;
  ...
  encryptedBaseURI: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "encryptedBaseURI"
  ): TypedContractMethod<[identifier: BigNumberish], [string], "view">;
  getFunction(
