...
export interface ISignatureActionInterface extends Interface {
...
export interface ISignatureAction extends BaseContract {
  connect(runner?: ContractRunner | null): ISignatureAction;
  waitForDeployment(): Promise<this>;

  interface: ISignatureActionInterface;
  ...
  verify: TypedContractMethod<
    [req: ISignatureAction.GenericRequestStruct, signature: BytesLike],
