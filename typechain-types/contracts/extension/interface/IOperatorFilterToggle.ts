...
export interface IOperatorFilterToggleInterface extends Interface {
  getFunction(
...
export interface IOperatorFilterToggle extends BaseContract {
  connect(runner?: ContractRunner | null): IOperatorFilterToggle;
  waitForDeployment(): Promise<this>;

  interface: IOperatorFilterToggleInterface;
  ...
  ): TypedContractMethod<[restriction: boolean], [void], "nonpayable">;
