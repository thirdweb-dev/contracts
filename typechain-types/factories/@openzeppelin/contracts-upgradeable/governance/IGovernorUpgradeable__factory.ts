...
} from "../../../../@openzeppelin/contracts-upgradeable/governance/IGovernorUpgradeable";
...
export class IGovernorUpgradeable__factory {
  ...
  static createInterface(): IGovernorUpgradeableInterface {
    return new Interface(_abi) as IGovernorUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IGovernorUpgradeable;
  }
}
