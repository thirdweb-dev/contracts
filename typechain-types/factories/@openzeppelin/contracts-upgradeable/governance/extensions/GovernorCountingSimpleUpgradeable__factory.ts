...
} from "../../../../../@openzeppelin/contracts-upgradeable/governance/extensions/GovernorCountingSimpleUpgradeable";
...
export class GovernorCountingSimpleUpgradeable__factory {
  ...
  static createInterface(): GovernorCountingSimpleUpgradeableInterface {
    return new Interface(_abi) as GovernorCountingSimpleUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as GovernorCountingSimpleUpgradeable;
  }
}
