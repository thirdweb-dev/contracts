...
} from "../../../../@openzeppelin/contracts-upgradeable/governance/GovernorUpgradeable";
...
export class GovernorUpgradeable__factory {
  ...
  static createInterface(): GovernorUpgradeableInterface {
    return new Interface(_abi) as GovernorUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as GovernorUpgradeable;
  }
}
