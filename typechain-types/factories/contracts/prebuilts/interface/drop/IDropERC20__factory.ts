...
import type {
  IDropERC20,
  IDropERC20Interface,
} from "../../../../../contracts/prebuilts/interface/drop/IDropERC20";
...
export class IDropERC20__factory {
  ...
  static createInterface(): IDropERC20Interface {
    return new Interface(_abi) as IDropERC20Interface;
  }
  static connect(address: string, runner?: ContractRunner | null): IDropERC20 {
    return new Contract(address, _abi, runner) as unknown as IDropERC20;
  }
}
