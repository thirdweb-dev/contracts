...
*Emitted when a plugin is added; emitted for each function of the plugin.*
...
*Emitted when a plugin is removed; emitted for each function of the plugin.*
...
*Emitted when plugin is updated; emitted for each function of the plugin.*
