...
async function main() {
  ...
  const artifact: ZkSyncArtifact = (await hre.artifacts.readArtifact("EditionStake")) as ZkSyncArtifact;
  ...
  console.log("Deployed EditionStake \n: ", contract.address);

  console.log("\n");

  console.log("Verifying contract.");
  await verify(contract.address, "contracts/prebuilts/staking/EditionStake.sol:EditionStake", [
