...
async function main() {
  ...
  const artifact: ZkSyncArtifact = (await hre.artifacts.readArtifact("Pack")) as ZkSyncArtifact;
  ...
  await verify(contract.address, "contracts/prebuilts/pack/Pack.sol:Pack", [
