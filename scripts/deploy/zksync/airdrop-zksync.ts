...
async function main() {
  ...
  const artifact: ZkSyncArtifact = (await hre.artifacts.readArtifact("Airdrop")) as ZkSyncArtifact;
  ...
  await verify(contract.address, "contracts/prebuilts/airdrop/Airdrop.sol:Airdrop", []);
}
