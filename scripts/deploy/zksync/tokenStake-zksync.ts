...
async function main() {
  ...
  const artifact: ZkSyncArtifact = (await hre.artifacts.readArtifact("TokenStake")) as ZkSyncArtifact;
  ...
  console.log("Deployed TokenStake \n: ", contract.address);

  console.log("\n");

  console.log("Verifying contract.");
  await verify(contract.address, "contracts/prebuilts/staking/TokenStake.sol:TokenStake", [
