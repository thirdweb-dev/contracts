...
async function main() {
  ...
  const artifact: ZkSyncArtifact = (await hre.artifacts.readArtifact("Multiwrap")) as ZkSyncArtifact;
  ...
  await verify(contract.address, "contracts/prebuilts/multiwrap/Multiwrap.sol:Multiwrap", [
