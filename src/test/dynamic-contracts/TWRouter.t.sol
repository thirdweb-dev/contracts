...
contract TWRouterImplementation is TWRouter {
    constructor(address _extensionRegistry, string memory _contractType) TWRouter(_extensionRegistry, _contractType) {}
...
contract TWRouterTest is BaseTest, IExtension {
    ...
    string private contractType = "ExampleContact";
    ...
    function setUp() public virtual override {
        ...
        address routerImpl = address(new TWRouterImplementation(address(extensionRegistry), contractType));
    ...
    function test_state_removeExtension() external {
        ...
        assertEq(twRouter.getExtension(extensions[3].metadata.name).metadata.implementation, address(0));
    }
