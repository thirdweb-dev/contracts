...
abstract contract BaseTest is DSTest, Test {
    ...
    uint256[] public _airdropWalletClaimCountERC1155;
    uint256[] public _airdropAmountsERC1155;
    bytes32[] public _airdropMerkleRootERC1155;
    ...
    function setupAirdropClaimable() public {
        ...
        inputs[0] = "node";
        inputs[1] = "src/test/scripts/generateRootForAirdrop.ts";
