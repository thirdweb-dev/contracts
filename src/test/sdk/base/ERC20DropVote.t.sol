...
import { ERC20DropVote } from "contracts/base/ERC20DropVote.sol";
...
contract BaseERC20DropVoteTest is BaseUtilTest {
    ...
    function setUp() public override {
        super.setUp();
        vm.prank(signer);
        base = new ERC20DropVote(NAME, SYMBOL, CONTRACT_URI, saleRecipient);
        ...
        returns (bytes memory)
    {
        ...
        bytes32 domainSeparator = keccak256(abi.encode(typehashEip712, nameHash, versionHash, block.chainid, address(base)));
    ...
    function test_state_claim_ZeroPrice() public {
        ...
        ERC20DropVote.AllowlistProof memory alp;
        alp.proof = proofs;
    ...
    function test_state_claim_NonZeroPrice_ERC20() public {
        ...
        vm.prank(claimer);
        erc20.approve(address(base), 1_000 ether);
    ...
    function test_revert_delegateBySig_InvalidNonce() public {
        // generate delegation signature
        address _delegatee = address(0x789);
        uint256 _nonce = base.nonces(recipient);
        uint256 _expiry = 1000;
        ...
        base.delegateBySig(_delegatee, _nonce + 1, _expiry, v, r, s);
    }

    function test_revert_delegateBySig_SignatureExpired() public {
        // generate delegation signature
        address _delegatee = address(0x789);
        uint256 _nonce = base.nonces(recipient);
        uint256 _expiry = 1000;
