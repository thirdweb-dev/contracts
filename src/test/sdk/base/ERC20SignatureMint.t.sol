...
import { ERC20SignatureMint } from "contracts/base/ERC20SignatureMint.sol";

contract BaseERC20SignatureMintTest is BaseUtilTest {
    ERC20SignatureMint internal base;
    ...
    ERC20SignatureMint.MintRequest _mintrequest;
    bytes _signature;
