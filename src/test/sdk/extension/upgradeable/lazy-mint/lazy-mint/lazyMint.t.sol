...
import { LazyMint, BatchMintMetadata } from "contracts/extension/upgradeable/LazyMint.sol";
import "../../../ExtensionUtilTest.sol";

contract MyLazyMintUpg is LazyMint {
    address admin;
...
contract UpgradeableLazyMint_LazyMint is ExtensionUtilTest {
    MyLazyMintUpg internal ext;
    ...
    function setUp() public override {
        ...
        ext = new MyLazyMintUpg(address(admin));
