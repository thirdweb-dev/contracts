...
contract MyBatchMintMetadata is BatchMintMetadata {
    ...
    function freezeBaseURI(uint256 _batchId, bool _freeze) public {
        batchFrozen[_batchId] = _freeze;
    }
...
contract BatchMintMetadata_SetBaseURI is ExtensionUtilTest {
    ...
    function test_setBaseURI() public whenBatchIdNotFrozen {
        ...
        string memory _baseURI = ext.getBaseURI(batchIds[indexToUpdate] - 1);
