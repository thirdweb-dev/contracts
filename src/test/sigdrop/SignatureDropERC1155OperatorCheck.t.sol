...
import { SignatureDrop1155OperatorCheck, IPermissions, ILazyMint } from "contracts/signature-drop/SignatureDrop1155OperatorCheck.sol";
...
contract SignatureDrop1155OperatorCheckTest is BaseTest {
    ...
    event TokensMintedWithSignature(
        ...
        SignatureDrop1155OperatorCheck.MintRequest mintRequest
    );

    SignatureDrop1155OperatorCheck public drop;
    ...
    function setUp() public override {
        ...
        drop = SignatureDrop1155OperatorCheck(getContract("SignatureDrop1155OperatorCheck"));
    ...
    function test_claim_transferRole() public {
        ...
        SignatureDrop1155OperatorCheck.AllowlistProof memory alp;
        alp.proof = proofs;

        SignatureDrop1155OperatorCheck.ClaimCondition[]
            memory conditions = new SignatureDrop1155OperatorCheck.ClaimCondition[](1);
    ...
    /**
     *  note: Testing transfer of tokens when operator-role is restricted
     */
    function test_claim_operatorRole() public {
        vm.warp(1);
        ...
        address operator = address(0x987);
        // approve tokens to operator
        vm.prank(receiver);
        drop.setApprovalForAll(operator, true);

        // revoke operator-role from address(0)
        vm.prank(deployerSigner);
        drop.revokeRole(keccak256("OPERATOR_ROLE"), address(0));
        vm.prank(operator);
        ...
        vm.prank(deployerSigner);
        drop.grantRole(keccak256("OPERATOR_ROLE"), operator);
        vm.prank(operator);
        drop.safeTransferFrom(receiver, address(123), 0, 0, "");
    }
    ...
    function signMintRequest(SignatureDrop1155OperatorCheck.MintRequest memory mintrequest, uint256 privateKey)
        internal
        view
    ...
    function test_state_mintWithSignature() public {
        ...
        drop.lazyMint(100, "ipfs://", emptyEncodedBytes);
        uint256 id = 0;
        SignatureDrop1155OperatorCheck.MintRequest memory mintrequest;
     ...
     *  note: Testing state changes; minting with signature, for a given price and currency.
     */
    function mintWithSignature(SignatureDrop1155OperatorCheck.MintRequest memory mintrequest) internal {
        vm.prank(deployerSigner);
        drop.lazyMint(100, "ipfs://", emptyEncodedBytes);
        uint256 id = 0;
    ...
    function test_claimCondition_startIdAndCount() public {
        ...
        SignatureDrop1155OperatorCheck.ClaimCondition[]
            memory conditions = new SignatureDrop1155OperatorCheck.ClaimCondition[](2);
    ...
    function test_claimCondition_startPhase() public {
        ...
        SignatureDrop1155OperatorCheck.ClaimCondition[]
            memory conditions = new SignatureDrop1155OperatorCheck.ClaimCondition[](3);
