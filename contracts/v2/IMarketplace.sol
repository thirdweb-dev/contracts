...
interface IMarketplace {
    ...
    /// @notice Type of the token listed for sale.
    enum TokenType {
        ERC1155,
        ERC721
    }
     ...
     * @param secondsUntilEndTime No. of seconds after which the listing is inactive. For direct listings:
    ...
    /**
     * @notice Lets someone buy a given quantity of tokens from a direct listing.
     *
     ...
     *                        being auctioned, regardless of the value of `_quantityToList` passed.
     *                        For direct listings: the quantity of NFTs from the listing, for which
    ...
    /**
     * @notice Lets a listing's creator accept an offer for their direct listing.
    ...
    /**
     * @notice Lets auction's creator collect the winning bid, and the winning bidder collect the auctioned
     *         NFTs, after the auction's end.
