...
contract ThirdwebRegistry is TWAccessControl {
    ...
    function updateDeployments(
        ...
        require(hasRole(FACTORY_ROLE, msg.sender), "not factory");
    ...
    function getAllModulesOfType(bytes32 _moduleType, address _deployer) external view returns (address[] memory allModulesOfType) {
