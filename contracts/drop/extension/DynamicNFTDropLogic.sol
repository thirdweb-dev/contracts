...
import { NFTMetadata } from "../../dynamic-contracts/extension/NFTMetadata.sol";

contract DynamicNFTDropLogic is
    ContractMetadata,
    PlatformFee,
    Royalty,
    PrimarySale,
    ...
    ERC721AUpgradeable
{
    ...
    /// @dev Only accounts with the METADATA_ROLE can update the metadata of NFTs.
    ...
    function _canSetMetadata() internal view virtual override returns (bool) {
        return _hasRole(METADATA_ROLE, _msgSender());
    }
