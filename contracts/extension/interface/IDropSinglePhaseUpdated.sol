...
interface IDropSinglePhaseUpdated is IClaimCondition {
    ...
    event ClaimConditionUpdated(ClaimCondition claimCondition, bool resetEligibility);

    /// @dev Emitted when the contract's claim conditions are updated.
    event ClaimConditionUpdated(ClaimCondition claimCondition, uint256 tokenId, bool resetEligibility);
