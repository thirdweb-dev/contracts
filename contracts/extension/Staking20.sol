...
abstract contract Staking20 is ReentrancyGuard, IStaking20 {
    ...
    constructor(
        ...
        require(uint160(_stakingToken) != 0 && uint160(_nativeTokenWrapper) != 0, "address 0");
    ...
    function setRewardRatio(uint256 _numerator, uint256 _denominator) external virtual {
        ...
        StakingCondition memory condition = stakingConditions[nextConditionId - 1];
        uint256 cachedDenomiator = condition.rewardRatioDenominator;
        uint256 cachedNumerator = condition.rewardRatioNumerator;
        require(_numerator != cachedNumerator || _denominator != cachedDenomiator, "Reward ratio unchanged.");
    ...
    function _withdraw(uint256 _amount) internal virtual {
        ...
        //underflow impossible since amount to be withdrawed is already checked
        unchecked {
