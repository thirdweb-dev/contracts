...
contract SignatureDropERC721A is
    Initializable,
    IThirdwebContract,
    IThirdwebOwnable,
    IThirdwebRoyalty,
    ...
    ERC721A
{
    ...
    constructor(address _thirdwebFee) initializer ERC721A("Name", "SYMBOL") {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721A, AccessControlEnumerableUpgradeable, IERC165Upgradeable)
        returns (bool)
    {
